...
<h3>Notes are displayed Here</h3>
    <div class="fieldset">
        <div class= "toall">
             <asp:CheckBox ID="IsEveryone" runat="server" ClientIDmode="Static"/>
              <asp:Label runat="server" ID="lbtoEveryone">Broadcast</asp:Label>
        </div>
        <div class= "privateField">
             <asp:CheckBox ID="IsPrivate" runat="server" ClientIDmode="Static"/>
              <asp:Label runat="server" ID="lblPrivate">Private</asp:Label>
        </div>
 ...
 <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ClientIDMode="Static"
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" ClientIDMode="Static"
    >
    <Columns>
     ...
     <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" ClientIDMode="Static">
    <Columns>
         <asp:TemplateField HeaderText="PRIVATE NOTES">
        <ItemTemplate>
            <asp:Label ID="lbNote" runat="server" Text='<%# Eval("Note") %>'></asp:Label>
        </ItemTemplate>
    </asp:TemplateField>
