    ...
    <div class="form-container">
        ...
        <div class="form-container">
            ...
            <div class="container-permanent-address">
                <div class="header-text" >
                    <h3  title="to change the permanent address uncheck the checkbox first">Permanent-Address <label for="sameas">(Same as present </label><span><input type="checkbox" name="sameas" id="sameas"
                                ></span>)</h3>
                </div>
                ...
                <div class="input-field-group">
                    ...
                    <div class="input-field">
                        ...
                        <select name="state-names-permanent" id="stateNamesPermanent" type="text" fieldName="Permanent-State-Name" importantField="true" clientStaticMode="static" runat="server" >
                            <option value="">Select State</option>
                        </select>
                    </div>
                </div>
            ...
            <div class="input-field-group">
                ...
                <div class="input-field">
                    ...
                    <input type="checkbox" name="subscribe" ID="subscribe" fieldName="Subscribed"  runat="server" ClientIDMode="static">
                </div>
