...
namespace EmployeeManagement.Web
{
    ...
    /// </summary>
    public class EditUserHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            u.UserID = Int32.Parse(formData["UserID"]);
            ...
            bool edited = AccessUserBusiness.EditUser(u);
            if(edited)
            {
                String userroles = formData["userroles[]"];
                int[] userroless = userroles.Split(',').Select(Int32.Parse).ToArray();
                AccessUserBusiness.EditUserRoles(userroless , Int32.Parse(formData["UserID"]));
